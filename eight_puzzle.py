...
def process_file(filename, algorithm, param):
    """ a function that processes files containing number strings.
    """
    num_solved = 0
    num_moves = 0
    num_states = 0
    ...
    for line in file:
        ...
        try:
            ...
            if soln == None:
                ...
                print(puzzle + ':', soln.num_moves, 'moves,', searcher.num_tested, 'states tested')
    ...
    if num_solved >= 1: 
        ...
        print('averages:', num_moves/num_solved, 'moves', num_states/num_solved, 'states tested')
